...
public class XorInt128 extends SimpleInstruction {
    ...
    static void init() {
        NodeParser.addCreator("xor-int128", new NodeParser.SimpleInstructionCreator((objs) -> new XorInt128((int) objs[0], (int) objs[1], (int) objs[2]), Register, Register, Register));
    }
