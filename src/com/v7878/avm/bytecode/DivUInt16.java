...
public class DivUInt16 extends SimpleInstruction {
    ...
    static void init() {
        NodeParser.addCreator("div-uint16", new NodeParser.SimpleInstructionCreator((objs) -> new DivUInt16((int) objs[0], (int) objs[1], (int) objs[2]), Register, Register, Register));
    }
