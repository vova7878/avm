...
public class SubInt128 extends SimpleInstruction {
    ...
    static void init() {
        NodeParser.addCreator("sub-int128", new NodeParser.SimpleInstructionCreator((objs) -> new SubInt128((int) objs[0], (int) objs[1], (int) objs[2]), Register, Register, Register));
    }
